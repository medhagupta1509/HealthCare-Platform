        ...
        <div>
          <div className="lg:w-[570px]">
            ...
            <p className='text_para'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. 
               Labore rerum temporibus quia voluptates delectus atque 
              repudiandae optio aliquam inventore perferendis, cum suscipit nobis?
            </p>
      ...
      <div className="flex items-center justify-between flex-col lg:flex-row">
        ...
        <div className="xl:w-[670px]">
          ...
          <ul className="pl-4">
            ...
            <li className='text_para'>
              3. View our physicians who are expecting new patients, use the online scheduling tool to select an appointment time.
            </li>
          </ul>
