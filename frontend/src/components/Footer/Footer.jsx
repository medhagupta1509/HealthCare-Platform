...
const Footer = () => {
  ...
  return(
    <footer className='pb-16 pt-10 bg-[#9af0f0]'>
      <div className='container'>
        <div className="flex justify-between flex-col md:flex-row flex-wrap gap-[30px] bg">
          <div>
            <img src={logo} alt=" "/>
            <p className='text-[16px] leading-7 font-[400] text-textColor mt-4'>
              Copyright {year} developed by XXXX all rights reserved.
            </p>
